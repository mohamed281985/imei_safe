              ...
              <div className="relative px-0">
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <Button
                    ...
                    className={`w-full h-14 rounded-2xl text-white text-lg font-bold flex items-center justify-center gap-2 shadow-[0_10px_20px_rgba(249,115,22,0.3)] hover:shadow-[0_15px_25px_rgba(249,115,22,0.4)] transition-all active:scale-[0.98] ${isEmailRegistered ? 'bg-gray-400 cursor-not-allowed' : 'bg-gradient-to-r from-orange-500 to-orange-600'
                      }`}
                  >
                    {loading ? (
