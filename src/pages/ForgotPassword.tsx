    ...
    <PageContainer>
      <div className="flex-1 flex flex-col items-center">
        ...
        <form onSubmit={sendResetPassword} className="space-y-4 max-w-xs mx-auto">
          <input
            type="email"
            className="w-full px-3 py-2 text-black rounded border border-gray-400 focus:outline-none focus:border-imei-cyan"
        ...
        <div className="text-center">
          <Link to="/login" className="text-blue-500 font-bold hover:text-imei-cyan hover:underline flex items-center justify-center mt-4">
